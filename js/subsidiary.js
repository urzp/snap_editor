canvas.arc_params = function(m_xy, r_xy, x_rotation, large_arc, sweep, end_xy, d){
...
canvas.test_arc_params = function(){
	var m_xy = {x:10,y:10}
	var r_xy = {x:20,y:20}
	...
	var large_arc = 0
	var sweep = 0 
	console.log(this.arc_params(m_xy, r_xy, x_rotation, large_arc, sweep, end_xy) )
}

canvas.test_arc_params_2 = function(){
	var m_xy = {x:50,y:50}
	...
	console.log(d)
	console.log(this.arc_params(m_xy, null, x_rotation, large_arc, null, end_xy, d) )
}